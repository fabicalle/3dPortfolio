...
import iconTwitter from "./image/icon-twitter.svg";
...
export default function App() {
  return (
    <Wrapper>
      <Spline
        className="spline"
        scene="https://prod.spline.design/ujSMlJ94m83VO8ZT/scene.splinecode"
      />
      <Content>
        <Menu>
          <li>
...
const Wrapper = styled.div`
  ...
  .spline {
    ...
    @media (max-width: 1024px) {
      tranform: scale(0.8) translatex(200px);
    ...
    @media (max-width: 375px) {
      tranform: scale(0.45) translateX(-50px);
    }
  }
`;
